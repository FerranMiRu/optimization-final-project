...
import main.java.agents.robinBaumgarten.Agent;
...
public class GenerateLevel {
    ...
    public static void main(String[] args) {
        MarioLevelGenerator generator = new main.java.levelGenerators.notch.LevelGenerator();
        String level = generator.getGeneratedLevel(
            new MarioLevelModel(150, 16),
